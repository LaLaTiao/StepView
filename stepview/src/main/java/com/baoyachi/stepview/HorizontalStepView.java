...
public class HorizontalStepView extends LinearLayout implements HorizontalStepsViewIndicator.OnDrawIndicatorListener {
    ...
    public HorizontalStepView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUnComplectedTextColor = ContextCompat.getColor(this.getContext(), R.color.common_text_grey);
        this.mComplectedTextColor = ContextCompat.getColor(this.getContext(), R.color.common_text_blue);
        this.mTextSize = 14;
        this.init();
    }
